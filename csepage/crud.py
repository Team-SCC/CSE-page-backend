...
# from csepage import schemas, models
...
#     default_password = student.birth.strftime(
#         "%y%m%d"
#     )  # default password set password = Birth(YYMMDD)
...
#     new_session = models.Session(uuid=session.uuid, sid=session.sid)
...
# def create_lockerreservation(
#     db: Session, session: schemas.LockerReservationBase
# ) -> None:
